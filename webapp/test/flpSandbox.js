		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Warping Entry",
									"targetURL": "#WarpingEntryzppwarpingentry-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"WarpingEntryzppwarpingentry-display": {
								"semanticObject": "WarpingEntryzppwarpingentry",
								"action": "display",
								"description": "Warping Entry",
								"title": "Warping Entry",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=WarpingEntry.zppwarpingentry",
									"url": sap.ui.require.toUrl("WarpingEntry/zppwarpingentry")
								}
							}
						}
					}
